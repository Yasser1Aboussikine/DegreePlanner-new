...
const Logo = () => {
  return (
    ...
    >
      <Shield className="h-5 w-6 bg-sidebar-primary text-sidebar-primary-foreground rounded-br-lg rounded-tr-sm rounded-tl-lg rounded-bl-sm flex-shrink-0" />
