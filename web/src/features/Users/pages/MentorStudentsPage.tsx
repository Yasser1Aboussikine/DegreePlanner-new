...
import { useGetStudentsByMentorIdQuery } from "@/store/api/mentorAssignmentApi";
...
export const MentorStudentsPage = () => {
  ...
  const { data, isLoading, error } = useGetStudentsByMentorIdQuery(
    user?.id || "",
    {
      skip: !user?.id,
    }
                  ...
                  {paginatedStudents.map((student) => (
                    <TableRow key={student.id}>
                      <TableCell className="font-medium">
                        <div
                          onClick={() =>
                            navigate(`/mentor/students/${student.id}/profile`)
                          }
